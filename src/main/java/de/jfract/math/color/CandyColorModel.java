 ...
 * Time: 17:00
 */
public class CandyColorModel extends ColorModel {
    public CandyColorModel() {
        super(75,20,80,750,20,800);
    }

    public CandyColorModel(double rconv, double gconv, double bconv, double rdiv, double gdiv, double bdiv) {
